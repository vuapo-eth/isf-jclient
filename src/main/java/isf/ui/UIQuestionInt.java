...
public class UIQuestionInt extends UIQuestion {
	...
	public static final UIQuestionInt Q_THREADS_AMOUNT = new UIQuestionInt(1, 1, true);
	public static final UIQuestionInt Q_THREADS_PRIORITY = new UIQuestionInt(1, 3, false).setQuestion("how much computational resources do you want to give each thread [1 = minimum, 2 = normal, 3 = maximum]");
	...
	public static final UIQuestionInt Q_LOG_INTERVAL = new UIQuestionInt(1, 3600, true).setQuestion("how many seconds do you wish the logger to wait between each info log (we recommend 60)");
